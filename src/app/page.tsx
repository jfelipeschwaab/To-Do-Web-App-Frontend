      ...
      <div className="min-h-screen bg-[#0C1117] flex justify-center w-1/2">
        <div className="shadow-2xl p-8 rounded-lg bg-[#2D353C] h-full flex flex-col w-full my-auto">
          ...
          <div className="mt-12 space-y-4">
            <h2 className="text-3xl text-[#E1E7EF] font-[var(--font-poppins)] font-bold">Benefícios de uma To-do List:</h2>
            <h3 className="text-2xl text-stone-300 font-[var(--font-poppins)] flex items-center gap-3">
